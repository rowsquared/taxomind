...
from taxomind.pipelines.supervised_pipes import pipeline as supervised_pipeline
...
def register_pipelines() -> dict[str, Pipeline]:
    ...
    supervised_pipe = supervised_pipeline.create_pipeline()

    pipelines = {
        "taxonomy_pipe": taxonomy_pipe,
        "zero_shot_pipe": zero_shot_pipe,
        "supervised_pipe": supervised_pipe,
    }
    pipelines["__default__"] = taxonomy_pipe + zero_shot_pipe + supervised_pipe
    return pipelines
